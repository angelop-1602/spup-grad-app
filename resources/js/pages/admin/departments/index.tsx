...
export default function DepartmentsIndex({ departments }: DepartmentsIndexProps) {
    const [openDepartments, setOpenDepartments] = useState<Record<number, boolean>>({});
                                        ...
                                        <div className="flex items-center justify-between">
                                            <div className="flex items-center gap-3">
                                                ...
                                                <div>
                                                    ...
                                                    <CardDescription>
                                                        Code: {department.code} • {department.courses_count}{' '}
                                                        {department.courses_count === 1 ? 'course' : 'courses'}
                                                    </CardDescription>
                                                </div>
                                            </div>
                                            <div className="flex items-center gap-2">
                                                ...
                                                >
                                                    <Link
                                                        href={adminRoutes.courses.create().url + `?department_id=${department.id}`}
                                                    >
                                                            ...
                                                            <div className="flex items-center gap-3">
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <p className="text-sm text-muted-foreground">
                                                                        Code: {course.code} • {course.majors.length}{' '}
                                                                        {course.majors.length === 1 ? 'major' : 'majors'}
                                                                    </p>
                                                                </div>
                                                            </div>
                                                            <div className="flex items-center gap-2">
                                                                ...
                                                                >
                                                                    <Link
                                                                        href={adminRoutes.majors.create().url + `?course_id=${course.id}`}
                                                                    >
                                                                        <Plus className="h-4 w-4" />
                                                                    </Link>
                                                                </Button>
                                                            ...
                                                            {course.majors.length > 0 ? (
                                                                course.majors.map((major) => (
                                                                    ...
                                                                    >
                                                                        ...
                                                                        >
                                                                            <Link
                                                                                href={adminRoutes.majors.edit({ major: major.id }).url}
                                                                            >
