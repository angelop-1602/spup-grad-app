...
interface UnverifiedApplicationsProps {
    drafts: {
        data: UnverifiedDraft[];
        current_page: number;
        last_page: number;
        per_page: number;
        total: number;
...
export default function UnverifiedApplicationsIndex({
    ...
    const updateFilters = (search: string, page = 1) => {
        router.get(
            adminRoutes.unverifiedApplications.index().url,
            {
    ...
    const verifyDraft = (draft: UnverifiedDraft) => {
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Unverified Applications" />
                        ...
                        {drafts.data.length > 0 ? (
                            ...
                            <div className="py-12 text-center">
                                ...
                                <p className="mt-2 text-sm text-muted-foreground">
                                    All guest application drafts are verified.
                                </p>
                            </div>
                        )}
                    </CardContent>
