...
function CountdownInlineGlass({
    timeLeft,
}: {
    timeLeft: NonNullable<TimeLeft>;
}) {
    ...
    return (
        <div className="inline-flex items-center gap-2 rounded-full bg-white/10 px-3 py-2 text-xs text-white/90 shadow-[0_8px_22px_rgba(0,0,0,0.18)] ring-1 ring-white/20 backdrop-blur-xl">
    ...
    return (
        <div className="grid grid-cols-4 gap-2 sm:gap-3">
            {items.map((item) => (
                <div
                    key={item.label}
                    className="relative overflow-hidden rounded-2xl bg-white/12 px-2 py-2 text-center shadow-[0_10px_26px_rgba(0,0,0,0.18)] ring-1 ring-white/20 backdrop-blur-xl"
                >
...
export default function Welcome({
    ...
    const closesAtReadable = formatIsoToReadable(
        windowStatus?.closesAt ?? null,
    );
        ...
        <>
            ...
            <div className="relative min-h-[100dvh] overflow-x-hidden">
                ...
                <div
                    ...
                    style={{
                        background:
                            'linear-gradient(180deg, rgba(3,102,53,0.2) 0%, rgba(3,102,53,1) 55%)',
                    }}
                />
                <div
                    ...
                    style={{
                        background:
                            'linear-gradient(90deg, rgba(3,102,53,1) 25%, rgba(3,102,53,0) 100%)',
                    }}
                />
                    ...
                    <div className="container mx-auto min-h-[100dvh] px-4 lg:px-8">
                        <div className="flex min-h-[100dvh] items-center py-8">
                            <div className="w-full max-w-2xl">
                                ...
                                <div className="flex flex-col items-center justify-start gap-2 text-center sm:flex-row sm:gap-3 sm:text-left">
                                    ...
                                    <div className="flex flex-col leading-tight">
                                        <span
                                            ...
                                            style={{
                                                fontFamily:
                                                    "'Old English Text MT', 'Old English', serif",
                                            }}
                                        >
                                            St. Paul University Philippines
                                        </span>
                                        <span
                                            className="text-xs font-medium text-white/90 sm:text-sm"
                                            style={{
                                                fontFamily:
                                ...
                                {/* Headline */}
                                <h1 className="mt-3 text-2xl leading-tight font-bold text-white sm:text-4xl">
                                    Graduation Application Portal
                                </h1>

                                {/* Description (kept compact to preserve one-page) */}
                                <p className="mt-3 text-sm leading-relaxed text-white/90 sm:text-base">
                                    Complete the full graduation application
                                    steps first, verify your email after you
                                    submit, and keep managing requirements
                                    through secure links sent to your inbox.
                                </p>

                                {/* Guided steps + primary action */}
                                <div className="mt-4 space-y-4">
                                    <div className="grid gap-3 text-sm text-emerald-50 sm:grid-cols-3">
                                        <div className="rounded-xl bg-white/10 p-3 shadow-[0_10px_30px_rgba(0,0,0,0.20)] ring-1 ring-white/20 backdrop-blur-2xl">
                                            <div className="text-xs font-semibold tracking-wide text-emerald-100/80 uppercase">
                                                Step 1
                                            </div>
                                            ...
                                            <p className="mt-1 text-xs text-emerald-100/80">
                                                ...
                                                application when the window is
                                                active.
                                            </p>
                                        </div>
                                        <div className="rounded-xl bg-white/10 p-3 shadow-[0_10px_30px_rgba(0,0,0,0.20)] ring-1 ring-white/20 backdrop-blur-2xl">
                                            ...
                                            <p className="mt-1 text-xs text-emerald-100/80">
                                                Open the link sent after
                                                submission to activate your
                                                application.
                                            </p>
                                        </div>
                                        <div className="rounded-xl bg-white/10 p-3 shadow-[0_10px_30px_rgba(0,0,0,0.20)] ring-1 ring-white/20 backdrop-blur-2xl">
                                            ...
                                            <div className="mt-1 font-medium">
                                                Track progress and reopen
                                            </div>
                                            <p className="mt-1 text-xs text-emerald-100/80">
                                                Use your tracking code and PIN
                                                from email to check status,
                                                reopen the portal, and request a
                                                fresh access link.
                                            </p>
                                        </div>
                                    </div>
                                ...
                                <div className="mt-4">
                                    {showCountdown ? (
                                        <div className="rounded-3xl bg-white/10 p-4 shadow-[0_10px_30px_rgba(0,0,0,0.20)] ring-1 ring-white/20 backdrop-blur-xl">
                                            <div className="flex items-center justify-between gap-3"></div>
                                            <div className="flex flex-wrap items-center gap-2">
                                                <Badge
                                                    variant="outline"
                                                    className="border-white/25 bg-white/10 text-white/90 backdrop-blur"
                                                >
                                                ...
                                                {windowStatus?.name ? (
                                                    <Badge
                                                        variant="outline"
                                                        className="border-white/25 bg-white/5 text-white/90"
                                                    >
                                                        Window:{' '}
                                                        {windowStatus.name}
                                                    </Badge>
                                            ...
                                            <div className="mt-2 text-[11px] font-medium tracking-wide text-white/80 uppercase">
                                                {statusHint}
                                            </div>
                                            {/* xs: compact inline */}
                                            <div className="mt-3 sm:hidden">
                                                {timeLeft ? (
                                                    <CountdownInlineGlass
                                                        timeLeft={timeLeft}
                                                    />
                                                ) : null}
                                            </div>
                                            ...
                                            <div className="mt-3">
                                                <Dialog>
                                                    ...
                                                    <DialogContent className="max-h-[90vh] !max-w-5xl overflow-y-auto p-6">
                                                        <DialogHeader>
                                        ...
                                        <div className="inline-flex items-center rounded-full bg-white/10 px-4 py-2 text-xs font-medium text-white shadow-sm ring-1 ring-white/15 backdrop-blur-sm">
                ...
                <div className="group fixed bottom-3 left-3 z-30 sm:bottom-5 sm:left-5">
                    ...
                    >
                        <p className="font-medium tracking-wide text-white/55 uppercase">
                            Version {version}
                        </p>
                        ...
                        <a
                            href="mailto:aperalta@spup.edu.ph"
                            className="mt-1 block text-white/65 transition hover:text-white"
                        >
                            aperalta@spup.edu.ph
                        </a>
                    </div>
                    <button
                        type="button"
                        aria-label="Application version and developer"
                        aria-expanded={isDeveloperInfoOpen}
                        onClick={() =>
                            setIsDeveloperInfoOpen((isOpen) => !isOpen)
                        }
                        className="rounded-full bg-white/[0.04] px-2 py-1 text-[10px] font-medium tracking-wide text-white/40 ring-1 ring-white/10 backdrop-blur-md transition hover:bg-white/10 hover:text-white/75 focus-visible:ring-2 focus-visible:ring-white/40 focus-visible:outline-none"
                    >
                        v{version}
                    </button>
                </div>
